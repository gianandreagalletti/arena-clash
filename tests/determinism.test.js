...
function scriptedInputs(tick) {
  ...
  // movement, aiming and firing for all 3 players.
  const t = tick / 60;
  return [
    { ...NEUTRAL_INPUT, moveX: Math.sin(t), moveY: Math.cos(t * 0.7), aimX: 1, aimY: 0, fire: tick % 10 === 0 },
    { ...NEUTRAL_INPUT, moveX: -Math.cos(t * 0.5), moveY: Math.sin(t), aimX: -1, aimY: 0.3, fire: tick % 13 === 0 },
    { ...NEUTRAL_INPUT, moveX: 0.5, moveY: -0.5, aimX: 0, aimY: -1, fire: tick % 7 === 0 },
  ];
}
